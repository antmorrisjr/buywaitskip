      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 50, borderBottom: "1px solid rgba(255,255,255,0.1)", backgroundColor: "rgba(10,10,18,0.95)", backdropFilter: "blur(12px)" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, padding: "12px 16px" }}>
          ...
          <div style={{ display: isMobile ? "none" : "flex", alignItems: "center", gap: 32 }}>
            <a href="/trending" style={{ color: GREEN, textDecoration: "none", fontWeight: 500, fontSize: 13, textTransform: "uppercase", letterSpacing: "0.1em" }}>Trending</a>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", backgroundColor: "rgba(10,10,18,0.98)", padding: "16px" }}>
            {[
              ...
              <a key={link.label} href={link.href} onClick={() => setMenuOpen(false)}
                style={{ display: "block", color: link.href === "/trending" ? GREEN : "rgba(255,255,255,0.85)", fontSize: 15, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", padding: "12px 8px", textDecoration: "none", borderRadius: 8, borderBottom: "1px solid rgba(255,255,255,0.06)" }}
              >{link.label}</a>
            ))}
          </div>
        )}
            ...
            {games.map((game, index) => {
              ...
              return (
                <a key={game.id} href={`/game/${game.slug}`} style={{ textDecoration: "none" }}>
                  ...
                  >
                    <div style={{ position: "absolute", top: 8, left: 8, zIndex: 3, width: 24, height: 24, borderRadius: "50%", backgroundColor: "rgba(0,0,0,0.8)", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: "bold", color: "rgba(255,255,255,0.7)" }}>
                      {index + 1}
                    </div>
                    {image ? (
